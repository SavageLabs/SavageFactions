...
public enum TL {
    ...
    COMMAND_ADMIN_PROMOTEDNORMAL("&e&l[!] &6%1$s &egave &6%2$s &ethe leadership of &6%3$s&e."),
    COMMAND_ADMIN_PROMOTEDAUTOLEAVE("&e&l[!] &7Faction admin &c%s&7 has been removed. &c%s&7 has been promoted as the new faction admin."),
    ...
    COMMAND_RELATIONS_COOLDOWN("&c&l[!]&c Your faction must wait at least &e%1 seconds&c between each relation wish."),
