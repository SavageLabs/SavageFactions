...
public enum TL {
    ...
    GENERIC_FACTIONTAG_TOOSHORT("The faction tag cannot be shorter than {amount} chars."),
    GENERIC_FACTIONTAG_TOOLONG("The faction tag cannot be longer than {amount} chars."),
    GENERIC_FACTIONTAG_ALPHANUMERIC("Faction tag must be alphanumeric. {name} is not allowed."),
    GENERIC_YOU("You"),
    ...
    CMD_FLY_CHANGE("commands.f-fly.cmd-change", "&7Faction Flight &c{toggled}&7."),
    CMD_FLY_COOLDOWN("commands.f-fly.cmd-cooldown", "&7You will not take fall damage for &c{amount} &7seconds."),
    CMD_FLY_DAMAGE("commands.f-fly.cmd-damage", "&7Faction Flight disabled due to entering combat."),
    CMD_FLY_OTHER_TERRITORY("commands.f-fly.cmd-anti-fly.cmd-other-territory", "&7Cannot fly in the territory of &c{faction}&7."),
    CMD_FLY_ANTI_EPEARL("commands.f-fly.cmd-anti-fly.cmd-anti-epearl", "&7Cannot throw pearls while flying!"),
    CMD_FLY_ENEMY_NEAR("commands.f-fly.cmd-enemy-checks.cmd-enemy-near", "&7Flight has been disabled, an enemy is nearby."),
    CMD_FLY_ENEMY_NEAR_ALERT("commands.f-fly.cmd-enemy-checks.cmd-enemy-near-alert", "&7Cannot fly here, an enemy is nearby."),
    // Factions Focus
    ...
    // Factions Warps
    CMD_F_CLICK_TO_WARP("commands.f-warp.cmd-click-to-warp", "&7Click To Warp!"),
    CMD_F_WARP_FORMAT("commands.f-warp.cmd-fwarp-format", "&7/f warp <warpname> &c[password]"),
    CMD_F_SUCCESSFUL_WARP("commands.f-warp.cmd-successful-warp", "&7Warped To &c{warp}&7."),
    CMD_F_WARP("commands.f-warp.cmd-invalid-warp.cmd-warp", "&7Could not find warp &c{invalid-warp}&7."),
    CMD_F_INVALID_PASSWORD("commands.f-warp.cmd-invalid-warp.cmd-password", "&7Invalid Password!"),
    CMD_F_WARPS("commands.f-warp.cmd-warps", "&7Warps: "),
    CMD_F_REQUIRED("commands.f-warp.cmd-warp-password.cmd-required", "&7Warp Password:"),
    CMD_F_TIME_OUT("commands.f-warp.cmd-warp-password.cmd-time-out", "&7Warp Password Timed Out."),
    // Factions Perms
    CMD_FPERMS_PERMISSION("commands.f-perms.cmd-permission", "&7You do not have permission to edit faction perms."),
    CMD_FPERMS_DESCRIPTION("commands.f-perms.cmd-description", "&7Edit or list your Faction's permissions."),
    CMD_FPERMS_DENY_ACTION("commands.f-perms.cmd-fperms-deny-action", "&7The faction leader does not allow you to &c{action}&7."),
    CMD_FPERM_RELATION("commands.f-perms.cmd-invalid.cmd-relation", "&7Invalid Relation Defined, Try something like Ally."),
    CMD_FPERM_ACCESS("commands.f-perms.cmd-invalid.cmd-access", "&7Invalid Access Defined, Try something like Allow."),
    CMD_FPERM_ACTION("commands.f-perms.cmd-invalid.cmd-action", "&7Invalid Action Defined, Try something like Build."),
    CMD_FPERM_SET("commands.f-perms.cmd-invalid.cmd-set", "&7Set Permission &c{perm}&7 to &c{toggled}&7 for relation &c{relation}&7."),
    CMD_FPERM_TOP("commands.f-perms.cmd-invalid.cmd-top", "RCT MEM OFF ALLY TRUCE NEUT ENEMY"),
    CMD_FPERM_LOCKED("commands.f-perms.cmd-invalid.cmd-locked", "&cThis permission has been locked by the server."),
    // Factions Homes
    ...
    // Factions Inspect
    COMMAND_INSPECT_DISABLED_MSG("commands.f-inspect.cmd-disabled-msg", "&7Inspection Mode is now disabled."),
    COMMAND_INSPECT_ENABLED_MSG("commands.f-inspect.cmd-enabled-msg", "&7Inspection Mode is now enabled."),
    COMMAND_INSPECT_NO_FAC_MSG("commands.f-inspect.cmd-no-fac-msg", "&7Inspection Mode is now disabled because you do not have a faction."),
    COMMAND_INSPECT_HEADER("commands.f-inspect.cmd-inspect-header", "&c&m---&7Inspect Data&c&m---&c//&7x:{x},y:{y},z:{z}"),
    COMMAND_INSPECT_ROW("commands.f-inspect.cmd-inspect-row", "&c{time} &7// &c{action} &7// &c{player} &7// &c{block-type}"),
    COMMAND_INSPECT_NO_DATA("commands.f-inspect.cmd-inspect-no-data", "&7No data was found!"),
    COMMAND_INSPECT_NOT_IN_CLAIM("commands.f-inspect.cmd-inspect-not-in-claim", "&7You can only inspect in your faction claims."),
    COMMAND_INSPECT_BYPASS("commands.f-inspect.cmd-inspect-bypass", "&7Inspecting in Bypass Mode."),
    // Factions Invite
    ...
    CMD_KICK_FACTIONLESS_PLAYER("commands.f-kick.cmd-factionless-player", "&6That player is not in a faction."),
    ...
    CMD_FACTION_KICK_KICKS("commands.f-kick.cmd-faction-you-kicked","&7You kicked &c{player}&7 from the faction &c{faction}&7."),
    // Factions List
    ...
    CMD_ADMIN_DESCRIPTION("commands.faction-ranks.promo.cmd-admin-passing", "&7Hand over your adminstrator rights to the next person."),
    ...
    CMD_NO_HOME_N_A("commands.f-show.cmd-no-home", "&7N/A"),
    ...
    CMD_FACTION_EXEMPT("commands.f-show.cmd-exempt", "&7This faction is exempt and cannot be seen."),
    ...
    CMD_INVITE_PENDING("commands.f-showinvites.cmd-pending", "&7Players with pending invites: "),
    CMD_CLICK_TO_REVOKE("commands.f-showinvites.cmd-click-to-revoke", "&7Click to revoke invite for &c{invite}&7."),
    CMD_SPAWNER_TOGGLE("commands.f-spawnertoggle.cmd-toggle", "&7Spawner placing has been toggled &c{toggled}&7."),
    CMD_SPAWNER_PLACE_DENY("commands.f-spawnertoggle.cmd-place-deny", "&7Spawner placing is currently disabled."),
    CMD_FORMAT_F_STATUS("commands.f-status.cmd-format", "&c{power}&7 Power: &c{target}&7 last seen: &c{timestamp}&7."),
    CMD_STATUS_ONLINE("commands.f-status.cmd-online", "&7Online"),
    CMD_AGO_SUFFIX("commands.f-status.cmd-ago-suffix", " ago."),
    CMD_STRIKES_CHANGED("commands.f-strikes.cmd-changed", "&7You have set &c{faction}&7 strikes to &c{strikes}&7."),
    CMD_STRIKES_INFO("commands.f-strikes.cmd-info", "&c{faction}&7 has &c{strikes}&7 strikes."),
    CMD_STRIKES_TARGET_INVALID("commands.f-strikes.cmd-target-invalid", "&7The faction &c{faction}&7 is invalid."),
    CMD_STRIKES_STRUCK("commands.f-strikes.cmd-struck", "&7Your faction has been changed by &c{target}&7, Your faction now has &c{strikes&7/&c{maxstrikes}&7."),
    CMD_STEALTH_ENABLE("commands.f-stealth.cmd-enable", "&cStealth &8» &7You enabled stealth mode."),
    CMD_STEALTH_DISABLE("commands.f-stealth.cmd-disable", "&cStealth &8» &7You disabled stealth mode."),
    CMD_MUST_BE_MEMBER("commands.f-stealth.cmd-must-be-member", "&cStealth &8» &7You must be in a faction to use this command."),
    CMD_STUCK_CANCELLED("commands.f-stuck.cmd-cancelled", "&7Teleporting cancelled because you were damaged."),
    CMD_STUCK_OUTSIDE("commands.f-stuck.cmd-outside", "&7Teleport cancelled because you left &c{radius}&7 block radius."),
    CMD_STUCK_EXISTS("commands.f-stuck.cmd-exists", "&7You are already teleporting, You must wait &c{time}&7."),
    CMD_STUCK_START("commands.f-stuck.cmd-start", "&7Teleport will commence in &c{time}&7. Do not take or deal damage."),
    CMD_STUCK_TELEPORT("commands.f-stuck.cmd-teleport", "&7Teleported safely to &c{x}&7, &c{y}&7, &c{z}&7."),
    ...
    CMD_DESCRIPTION_CHANGES("commands.f-title.cmd-description-changed","You have &cchanged&7 the &cdescription&7 for &c{faction}&7 to:"),
    CMD_DESCRIPTION_CHANGED("commands.f-title.cmd-description-changes","The faction&c {faction} changed their &cdescription &7to:"),
    // Factions Scoreboard
    ...
    CMD_TNTFILL_DISBAND_CONFIRM("commands.f-tntfill.cmd-tntfill-disband","&7Your Faction has&c {tnt} &7tnt left in the bank, it will be &clost&7 if the faction is &cdisbanded&7"),
    ...
    CMD_WILDERNESS_ENTER("commands.f-unclaim.cmd-unclaim-wilderness.cmd-wilderness-enter", "&2Wilderness"),
    CMD_WILDERNESS_DESCRIPTION("commands-f-unclaim.cmd-unclaim-wilderness.cmd-wilderness-claim", ""),
    CMD_SAFEZONE_CLAIM("commands.f-unclaim.cmd-unclaim-safezone.cmd-safezone-claim", "&7You have claimed &6&lSafeZone&7."),
    CMD_CLAIM_SAFEZONE("commands.f-unclaim.cmd-unclaim-safezone.cmd-overclaim-safezone", "You can not claim a Safe Zone."),
    CMD_CLAIM_WARZONE("commands.f-unclaim.cmd-unclaim-safezone.cmd-overclaim-warzone","You can not claim a War Zone."),
    ...
    CMD_LEAVE_DISBANDED("commands.f-leave.cmd-leave-disbanded", "&c{faction}&7 was disbanded because everyone left."),
    ...
    CHAT_MOD("commands.factions-utils.f-chat.f-mod", "mod chat"),
    CHAT_FACTION("commands.factions-utils.f-chat.f-faction", "faction chat"),
    CHAT_ALLIANCE("commands.factions-utils.f-chat.f-alliance", "alliance chat"),
    CHAT_TRUCE("commands.factions-utils.f-chat.f-truce", "truce chat"),
    CHAT_PUBLIC("commands.factions-utils.f-chat.f-public", "public chat"),
    CHAT_FORMAT("commands.factions-utils.econ.format", "###,###.###"),
    // F Roles
    ...
    // Player Use Category
    CMD_PLAYER_DENY_USE_WILDERNESS("commands.factions-utils.f-relations.player-use.cmd-player-use-wilderness", "&7You cannot use &c{item} &7in the wilderness."),
    CMD_PLAYER_DENY_USE_SAFEZONE("commands.factions-utils.f-relations.player-use.cmd-player-use-safezone", "&7You cannot use &c{item} &7in a safezone."),
    CMD_PLAYER_DENY_USE_WARZONE("commands.factions-utils.f-relations.player-use.cmd-player-use-warzone", "&7You cannot use &c{item} &7in a warzone."),
    CMD_PLAYER_DENY_USE_TERRITORY("commands.factions-utils.f-relations.player-use.cmd-player-use-territory", "&7You cannot &c{item} &7in the territory of &c{territory}."),
    CMD_PLAYER_DENY_USE_OWNED("commands.factions-utils.f-relations.player-use.cmd-player-use-owned", "&7You cannot use &c{item} &7in this territory, It is owned by: &c{faction}."),
    ...
    COMMAND_CONFIG_NOEXIST("&c&l[!]&7 No configuration setting {setting} exists."),
    ...
    COMMAND_CONFIG_INTREQUIRED("Cannot set {option} An integer (whole number) value required."),
    COMMAND_CONFIG_LONGREQUIRED("Cannot set {option} A long integer (whole number) value required."),
    COMMAND_CONFIG_DOUBLEREQUIRED("Cannot set {option} A double (numeric) value required."),
    COMMAND_CONFIG_FLOATREQUIRED("Cannot set {option} A float (numeric) value required."),
    COMMAND_CONFIG_INVALID_COLOUR("Cannot set {option} {color} is not a valid color."),
    COMMAND_CONFIG_INVALID_COLLECTION("{option} is not a data collection type which can be modified with this command."),
    COMMAND_CONFIG_INVALID_MATERIAL("Cannot change {option} set: {material} is not a valid material."),
    COMMAND_CONFIG_INVALID_TYPESET("{option} is not a data type set which can be modified with this command."),
    COMMAND_CONFIG_MATERIAL_ADDED("{option} set: Material {material} added."),
    COMMAND_CONFIG_MATERIAL_REMOVED("{option} set: Material {material} removed."),
    COMMAND_CONFIG_SET_ADDED("{option} set: {something} added."),
    COMMAND_CONFIG_SET_REMOVED("{option} set: {something} removed."),
    COMMAND_CONFIG_LOG(" (Command was run by {target}.)"),
    COMMAND_KICK_TOKICK("to kick someone from the faction"),
    COMMAND_KICK_FORKICK("for kicking someone from the faction"),
    COMMAND_CONFIG_ERROR_SETTING("Error setting configuration setting {oldsetting} to {newsetting}."),
    COMMAND_CONFIG_ERROR_MATCHING("Configuration setting {option} couldn't be matched, though it should be... please report this error."),
    COMMAND_CONFIG_ERROR_TYPE("{option} is of type {type}', which cannot be modified with this command."),
    ...
    COMMAND_LEAVE_DESCRIPTION("Leave your faction"),
    ...
    LEAVE_FORLEAVE("&7Leave your faction"),
