...
public class CmdKickAlt extends FCommand{
    ...
    public void perform(CommandContext context) {
        ...
        if (Conf.logFactionKick) {
            SavageFactions.plugin.log((context.sender instanceof ConsoleCommandSender ? "A console command" : context.fPlayer.getName()) + " kicked " + toKick.getName() + " from the faction: "
