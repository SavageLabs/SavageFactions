...
public abstract class FCommand {
    ...
    public boolean isEnabled(CommandContext context) {
        if (SavageFactions.plugin.getLocked() && requirements.disableOnLock) {
    ...
    public List<String> getToolTips(FPlayer player) {
        ...
        for (String s : SavageFactions.plugin.getConfig().getStringList("tooltips.show")) {
    ...
    public List<String> getToolTips(Faction faction) {
        List<String> lines = new ArrayList<>();
        for (String s : SavageFactions.plugin.getConfig().getStringList("tooltips.list")) {
