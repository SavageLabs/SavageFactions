...
public class CmdCreate extends FCommand {
    ...
    public void perform(CommandContext context) {
        ...
        if (Conf.logFactionCreate)
            SavageFactions.plugin.log(context.fPlayer.getName() + TL.COMMAND_CREATE_CREATEDLOG.toString() + tag);
        if (SavageFactions.plugin.getConfig().getBoolean("fpaypal.Enabled")) context.msg(TL.COMMAND_PAYPALSET_CREATED);
