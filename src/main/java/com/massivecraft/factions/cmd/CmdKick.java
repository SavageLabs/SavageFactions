...
public class CmdKick extends FCommand {
    ...
    public void perform(CommandContext context) {
        ...
        if (context.fPlayer == toKick) {
            ...
            context.msg(TL.GENERIC_YOUMAYWANT.toString() + SavageFactions.plugin.cmdBase.cmdLeave.getUseageTemplate(context));
            return;
        }
        ...
        if (Conf.logFactionKick) {
            SavageFactions.plugin.log((context.sender instanceof ConsoleCommandSender ? "A console command" : context.fPlayer.getName()) + " kicked " + toKick.getName() + " from the faction: " + toKickFaction.getTag());
        }
